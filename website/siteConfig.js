...
const siteConfig = {
  title: "Community Extruder and Compression Molding Machines", // Title for your website.
  tagline: "A website for testing",
  url: "https://devsonni.github.io", // Your website URL
  baseUrl: "/Extruder-and-Compressor-Machines/",
  onPageNav: 'separate',
  // remove /docs/ prefix
  docsUrl: "",
  ...
  projectName: "Extruder-and-Compressor-Machines",
  organizationName: "devsonni",
  // For top-level user or org sites, the organization is still the same.
  // e.g., for the https://JoelMarcey.github.io site, it would be set like...
  //   organizationName: 'JoelMarcey'

  // For no header links in the top nav bar -> headerLinks: [],
  headerLinks: [{ doc: "intro", label: "Extruder-and-Compressor-Machines" }],
